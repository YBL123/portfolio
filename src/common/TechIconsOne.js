...
const TechIconsOne = () => (
  <div className="tech-icon-wrap">
    ...
    <div className="javascript-wrap">
    <svg className="icon javascript-icon" viewBox="0 0 128 128">
    ...
    <h1 className="javascript-h1">JavaScript</h1>
    </div>  */}

    <div>
      <h1 className="javascript-h1">HTML</h1>
      <img className="icon javascript-icon-project" src={html} alt="html icon" />
    </div>
    <div>
      <h1 className="javascript-h1">JavaScript</h1>
      <img className="icon javascript-icon-project" src={js} alt="js icon" />
    </div>
    <div>
      <h1 className="javascript-h1">CSS</h1>
      <img className="icon javascript-icon-project" src={css} alt="css icon" />
    </div> 
